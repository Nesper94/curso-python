...
¡Así como el que usaban Galileo y Humboldt!
'''
...
def mercurio(d,h,vxg=400):
	'''
	Calcula el precio del mercurio necesario para construir un barómetro con el radio y la altura especificados.
...
if __name__=='__main__':
    ...
    print('El módulo fue importado desde python.')
